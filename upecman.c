            ...
            case 'd': 
                if(g.lab[g.pacman.pos.y][g.pacman.pos.x+1] != '#' )
                {
                    ...
                    if(g.pacman.pos.x == 8 && g.pacman.pos.y == 9)
                    {
                        ...
                        g.lab[g.pacman.anteripos.x][g.pacman.anteripos.y] = ' ';
                    }
                }
                break;
...
t_game movernadirecao(t_game g, int nomeDoFantasma)
{
    ...
    usleep(16000);
    if(g.lab[g.ghost[nomeDoFantasma].anteriorpos.y][g.ghost[nomeDoFantasma].anteriorpos.x] == 'B' || g.lab[g.ghost[nomeDoFantasma].anteriorpos.y][g.ghost[nomeDoFantasma].anteriorpos.x] == 'C' || g.lab[g.ghost[nomeDoFantasma].anteriorpos.y][g.ghost[nomeDoFantasma].anteriorpos.x] == 'P' || g.lab[g.ghost[nomeDoFantasma].anteriorpos.y][g.ghost[nomeDoFantasma].anteriorpos.x] == 'I')
    ...
    else if(g.pacman.primeira_pallet == 1)
    {
        g.lab[7][9]= '.';
    }
...
{ 
    ...
    for(f = blinky; f <= clyde; f++) /* blinky(0), pinky(1), inky(2) and clyde(3) */
    {
